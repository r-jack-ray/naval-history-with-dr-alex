...
11. Report the audited shard, whether it changed, strengthened content, topic slugs introduced, active creation rules used, unresolved review or ambiguous candidates, that synchronization ran with elevation, the corpus-wide synchronization result, the processing-log line appended, remaining thin ranges, and that the normalization catalog, manual topic-registry editing, corpus-wide topic rewriting, generation, tests, builds, and validation were intentionally not touched. Do not attribute every synchronized record to this shard.
